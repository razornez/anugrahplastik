      ...
      >
        <div className="transaction-create-dialog__head">
          <div>
            ...
            <h2 id="transaction-create-title">Mulai dari kebutuhan customer.</h2>
            <p>Detail nilai, barang, dan dokumen dilengkapi pada tahap Penawaran.</p>
          </div>
          <button aria-label="Tutup" className="dialog-close" onClick={closeDialog} type="button">
            ×
          </button>
        </div>
        <form className="transaction-create" action={formAction} aria-busy={isPending}>
          ...
          <div className="transaction-create__actions">
          ...
          {state.status !== "idle" ? (
            <p
              aria-live="polite"
              className={`transaction-create__message transaction-create__message--${state.status}`}
            >
              {state.message}
            </p>
          ) : null}
